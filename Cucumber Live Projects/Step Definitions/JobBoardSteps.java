...
public class JobBoardSteps extends BaseClass {
	...
	public void userFillsDetailsForNewUser() {
		// Enter all fields
		driver.findElement(By.id("user_login")).sendKeys("ladidah");
		driver.findElement(By.id("email")).sendKeys("ladidah@example.com");
		driver.findElement(By.id("first_name")).sendKeys("Ladi");
		driver.findElement(By.id("last_name")).sendKeys("Dah");
	...
	public void verifyNewUserAdded() {
		...
		driver.findElement(By.xpath("//input[@id='user-search-input']")).sendKeys("ladidah");
		driver.findElement(By.id("search-submit")).click();
		Assert.assertTrue(driver.findElement(By.xpath
				("//table//td[@class='email column-email']//a[contains(text(),\"ladidah@example.com\")]")).isDisplayed());
	}
